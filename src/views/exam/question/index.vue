<template>
  <div class="app-container">
    ...
    <data-grid url="/exam/question/list" dataName="listQuery" ref="dataList" @dataRest="onDataRest" >
      <template slot="form">
      ...
      <template slot="extendOperation">
        ...
        <el-popover placement="bottom" trigger="click">
          ...
          <el-button slot="reference" class="filter-item" style="margin-left: 10px;" type="primary" size="small" icon="el-icon-edit" >添加</el-button>
        </el-popover>
      </template>
      <!--body-->
      <template slot="body">
        <el-table-column align="center" prop="id" label="ID" width="60px"></el-table-column>
        <el-table-column align="center" prop="subjectId" label="科目名称" ></el-table-column>
      ...
      <el-table-column prop="difficult" label="难度" width="60px"/>
        ...
        <el-table-column label="修改时间">
         ...
         <el-table-column prop="creater" label="创建人" width="60px"/>
...
export default {
  name: "Question",
  components: { DataGrid,QuestionShow },
  directives: { waves },
  filters: {
    statusFilter(status) {
