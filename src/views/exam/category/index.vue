<template>
  <div class="app-container">
    ...
    <data-grid url="/exam/category/list" dataName="listQuery" ref="dataList" @dataRest="onDataRest" >
      <template slot="form">
    ...
    <el-dialog title="类别信息" :visible.sync="modifyVisible">
      <el-form :model="categoryForm" :rules="rules" ref="categoryForm" label-width="70px"  label-position="right" style="width: 400px; margin-left:50px;">
        <el-form-item label="类别名称" prop="name" size="medium">
          <el-input v-model="categoryForm.name" class="filter-item" placeholder="请输入类别名称" ></el-input>
        </el-form-item>
        <el-form-item label="状态">
...
<script>
import { getList,findById,save,drop} from "@/api/exam/category";
